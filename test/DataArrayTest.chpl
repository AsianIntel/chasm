...
proc data_array_addition(test: borrowed Test) throws {
    ...
    var d2 = new shared DataArray([length(0.01, 0, 2, "cm")], dimensions);
    var d3 = d1 + d2;
    ...
    var d5 = d2 + d1;
    var d6 = new shared DataArray([length(0.01, 0, 102, "cm")], dimensions);
...
//     var k2 = new shared DataArray([mass(0.001, 0, 2, "g"), mass(0.001, 0, 1000, "g")], dimensions);
//     var k3 = k1 - k2;
